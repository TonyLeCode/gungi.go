...
export type dragAndDropFunction = (
	node: HTMLElement,
...
export function createDragAndDrop() {
	...
	function drop(node: HTMLElement, options = {} as dropOptions) {
	...
	function dragAndDrop(node: HTMLElement, options = {} as dragAndDropOptions) {
		...
		function startDragMouse(e: MouseEvent) {
			...
			dragElement.style.zIndex = '3'; // TODO, adjust style
